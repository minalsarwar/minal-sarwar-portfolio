...
export const Route = createFileRoute("/brain")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A look at how I think across discovery, PRDs, flows, wireframes, prioritisation, collaboration, launch and feedback." },
...
const stages = [
  ...
  },
  {
    ...
    label: "04 · Shape",
    title: "Wireframes",
    body: "Low fi sketches that earn their way into Figma. Layout, hierarchy and microcopy, the boring parts that quietly make a product feel right.",
  ...
  },
  {
    ...
    body: "What ships first, what waits, what gets cut. Value vs effort, or a clear eyed conversation, whatever helps the team agree.",
    bullets: ["Value vs effort", "Trade off notes", "Release sequencing"],
    accent: true,
  },
  {
    icon: Users,
